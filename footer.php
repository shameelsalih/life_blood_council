  ...
  <div class="footer-top text-center mt-5 animate-without-visible fadeIn">
    ...
    <p class="mb-0 mt-1">All "Thalassemia" mentioned here is <b>"Beta Thalassemia Major"</b></p>
  </div>
  ...
  <footer class="animate" data-animation-name="fadeIn">
    <div class="footer-content container">
      <div class="row">
        ...
        <div class="col-lg-7">
          <div class="row">
            ...
            <div class="col-lg-6 footer-col-3">
              <ul>
                <li>
      ...
      <div class="row">
        <div class="copy-right-content d-none d-md-block">
        ...
        <div class="copy-right-content d-md-none">
          <div class="row">
            <div>
              Copyright &copy; 2022. All RIghts Reserved.
            </div>
