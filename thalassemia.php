...
<body>
  ...
  <main id="main-body">
    ...
    <section id="thalassemia-classification" class="py-5 mt-5">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <h3 class="secondary-color text-center mt-2"><span class="primary-color">Beta</span>-Thalassemia</h3>
            <div class="icon-card bg-custom-tertiary">
              <p class="content text-start quaternary-color p-3 fw-normal">
    ...
    <section id="thalassemia-treatment" class="py-5">
      <div class="container">
        ...
        <section id="thalassemia-qna" class="py-5 mt-5">
          <div class="container">
            <h4 class="primary-color text-center">You ask, We answer</h4>
            <div class="accordion pt-5 custom-accordion" id="thalassemia-accordion">
  ...
  <script>
    ...
    const renderAccordion = (accordionData) => {
      let innerHTML = ``;
      accordionData.forEach((data, key) => {
        innerHTML += `
      ...
      document.querySelector("#thalassemia-accordion").innerHTML = innerHTML;
    }
